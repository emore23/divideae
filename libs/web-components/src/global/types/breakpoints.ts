...
export type BreakpointSizeToken =
  typeof BreakpointSizeTokens[keyof typeof BreakpointSizeTokens];

export const defaultViewports = Object.values(BreakpointSizeTokens).reduce(
  (acc, bsKey: BreakpointSizeToken) => {
